...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/admin/List_Parcelas', [App\Http\Controllers\Lista\ParcelasList::class, 'listParcelas'])->name('admin.list.parcelas');
    Route::post('/admin/List_Parcelas/Open', [App\Http\Controllers\Lista\ParcelasList::class, 'listParcelasOpen'])->name('admin.list.parcelas.open');
    ...
    Route::post('/admin/List_ItemCompraAto', [App\Http\Controllers\Lista\ItemCompraAtoList::class, 'listItemCompraAto'])->name('admin.list.itemcompraato');
    Route::post('/admin/List_ItemCompraAto/Blur', [App\Http\Controllers\Lista\ItemCompraAtoList::class, 'listItemCompraAtoBlur'])->name('admin.list.itemcompraato.blur');
    ...
    Route::post('/admin/List_ItemVendaAto', [App\Http\Controllers\Lista\ItemVendaAtoList::class, 'listItemVendaAto'])->name('admin.list.itemvendaato');
    Route::post('/admin/List_ItemVendaAto/Blur', [App\Http\Controllers\Lista\ItemVendaAtoList::class, 'listItemVendaAtoBlur'])->name('admin.list.itemvendaato.blur');
