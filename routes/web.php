...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/admin/Usuario/Filtro', [App\Http\Controllers\UserController::class, 'Usuario'])->name('admin.filtro.usuario');
    Route::post('/admin/Cliente/Filtro', [App\Http\Controllers\ClienteController::class, 'Cliente'])->name('admin.filtro.cliente');
    Route::post('/admin/Contas/Filtro', [App\Http\Controllers\ContasController::class, 'Contas'])->name('admin.filtro.contas');
    Route::post('/admin/ContasaReceber/Filtro', [App\Http\Controllers\ContasaReceberController::class, 'ContasaReceber'])->name('admin.filtro.contasareceber');
    Route::post('/admin/Vendas/Filtro', [App\Http\Controllers\VendasController::class, 'Vendas'])->name('admin.filtro.vendas');
    Route::post('/admin/Produto/Filtro', [App\Http\Controllers\ProdutosController::class, 'Produto'])->name('admin.filtro.produto');
    Route::post('/admin/Estoque/Filtro', [App\Http\Controllers\EstoqueController::class, 'Estoque'])->name('admin.filtro.estoque');
    Route::post('/admin/Fornecedor/Filtro', [App\Http\Controllers\FornecedoresController::class, 'Fornecedores'])->name('admin.filtro.fornecedor');
    ...
    Route::get('/admin/Contas/Bar/Grafico', [App\Http\Controllers\GraficoController::class, 'contas_bar'])->name('admin.grafico.contas.bar');
    Route::get('/admin/Receber/Bar/Grafico', [App\Http\Controllers\GraficoController::class, 'receber_bar'])->name('admin.grafico.receber.bar');
    Route::get('/admin/Cliente/Bar/Grafico', [App\Http\Controllers\GraficoController::class, 'cliente_bar'])->name('admin.grafico.cliente.bar');
    ...
    Route::get('/admin/List_Parcelas/{id}', [App\Http\Controllers\Lista\ParcelasList::class, 'listParcelas']);
    ...
    Route::get('/admin/Cliente/Editar_cliente/{id}', [App\Http\Controllers\Update\ClienteUpdate::class, 'editCliente'])->name('admin.edit.cliente');
    ...
    Route::get('/admin/Financeiro/Editar_item_compra/{id}', [App\Http\Controllers\Update\CompraUpdate::class, 'editItemCompra'])->name('admin.edit.itemcompra');
    Route::get('/admin/Financeiro/Editar_credito/{id}', [App\Http\Controllers\Update\ContasaReceberUpdate::class, 'editReceber'])->name('admin.edit.receber');
    Route::get('/admin/Financeiro/Editar_venda/{id}', [App\Http\Controllers\Update\VendasUpdate::class, 'editVenda'])->name('admin.edit.venda');
    Route::get('/admin/Financeiro/Editar_item_venda/{id}', [App\Http\Controllers\Update\VendasUpdate::class, 'editItemVenda'])->name('admin.edit.itemvenda');
    Route::get('/admin/Produto/Editar_produto/{id}', [App\Http\Controllers\Update\ProdutoUpdate::class, 'editProduto'])->name('admin.edit.produto');
    Route::get('/admin/Produto/Editar_material_base/{id}', [App\Http\Controllers\Update\MaterialBaseUpdate::class, 'editMaterialBase'])->name('admin.edit.material');
    Route::get('/admin/Produto/Editar_tipo_produto/{id}', [App\Http\Controllers\Update\TipoProdutoUpdate::class, 'editTipoProduto'])->name('admin.edit.tipoproduto');
    ...
    Route::get('/admin/Detalhe/Editar_tipo_pagamento/{id}', [App\Http\Controllers\Update\TipoPagtoUpdate::class, 'editTipoPagto'])->name('admin.edit.tpgpagto');
