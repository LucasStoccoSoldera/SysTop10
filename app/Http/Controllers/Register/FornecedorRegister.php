...
class FornecedorRegister extends Controller
{
    ...
    protected function createFornecedor(Request $request)
    {
       ...
       if(isset($request->cpfFornecedor)){
        $validator_cpf_cnpj = Validator::make($request->cpfFornecedor,[
       ...
       $cpf = $request->cpfFornecedor;
        ...
        $validator_cpf_cnpj = Validator::make($request->cnpjFornecedor,[
        ...
        $validator_cpf_cnpj = Validator::make([$request->cpfFornecedor, $request->cnpjFornecedor],[
            'cpfFornecedor' => ['required', 'string', 'cpf'],
            'cnpjFornecedor' => ['required', 'string', 'cnpj'],
        ],
        [
    ...
    if(!empty($request->telefoneFornecedor && $request->celularFornecedor)){
       ...
       if(isset($request->telefoneFornecedor)){
        $validator_telefone_celular = Validator::make($request->telefoneFornecedor,[
       ...
       $telefone = $request->telefoneFornecedor;
        ...
        $validator_telefone_celular = Validator::make($request->celularFornecedor,[
        ...
        $validator_telefone_celular = Validator::make([$request->telefoneFornecedor, $request->celularFornecedor],[
            'telefoneFornecedor' => ['required', 'string', 'telefone'],
