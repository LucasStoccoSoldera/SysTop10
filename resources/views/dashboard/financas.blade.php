                ...
                @section('sub-menu')
                    <div class="add">
                        ...
                        <div class="dropdown-menu" id="add-menu">
                            <a class="dropdown-item" id="no-padding" href="{{  route('admin.Contas')  }}"><img src="../img/dash/contas.png" width="75" height="75"></a>
                            <a class="dropdown-item" id="no-padding" href="{{  route('admin.ContasaReceber')  }}"><img src="../img/dash/receber.png" width="75" height="75"></a>
                        </div>
                        </div>
                    </div>
                    @endsection
