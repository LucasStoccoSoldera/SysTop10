       ...
       <div class="content">
            <div class="col-12">
                <div class="row">
                      ...
                      <div class="input" id="cpf">
                              <input name="txt_qtde" id="cpf" type="text" class="form-control-filtro @error('txt_qtde') is-invalid @enderror">
                      ...
                      <div class="input"id="cpf">
                                  <input name="txt_status" id="cpf" type="text" class="form-control-filtro @error('txt_status') is-invalid @enderror">
            ...
            <div class="row">
                        ...
                        <div class="col-4">
                            <div class="card " id="card-consulta-tabela">
                            <div class="card-header" id="ch-adaptado">
                                <h2 class="card-title">Todos os Produtos <button class="btn btn-primary btn-block" id="btn-form-consulta-imprimir">Imprimir</button></h2>
                            </div>
                            <div class="card-body" id="cd-adaptado">
                                <div class="table-responsive">
                                <table class="table tablesorter " id="">
                    ...
                    <div class="add">
                        ...
                        <div class="dropdown-menu" id="add-menu">
                            <a class="dropdown-item" id="no-padding" data-toggle="modal" data-target="#modalRegisterEstoque"> <img src="../img/dash/materia_prima.png" width="75" height="75" ></a>
                        </div>
                        </div>
                    </div>
                    @endsection
                ...
                <div class="modal fade" id="modalRegisterEstoque" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog">
                        <form id="formRegisterEstoque" method="POST" autocomplete="off" enctype="multipart/form-data"  action="{{route('admin.create.estoque')}}">
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group" id="form-group">
                                                ...
                                                <input type="number"  name="qtdeEstoque" id="qtdeEstoque" class="form-control" maxlength="6" value="{{ old('qtdeEstoque') }}" placeholder="Entre com a Quantidade"autofocus>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group" id="form-group">
                                                <label class="modal-label">Dimensão do Produto:</label> <label style="color: red; font-size: 12px;"> * </label>
                                                <select type="text" name="IDDimensao" id="IDDimensao" class="form-control" value="{{ old('IDDimensao') }}" placeholder="Selecione com a Dimensão">
                                            ...
                                            <div class="form-group" id="form-group">
                                                <label class="modal-label">Cor do Produto:</label> <label style="color: red; font-size: 12px;"> * </label>
                                                <select type="text" name="IDCor" id="IDCor" class="form-control" value="{{ old('IDCor') }}" placeholder="Selecione com a Cor">
                                                    <option value="">------------Selecione------------</option>
