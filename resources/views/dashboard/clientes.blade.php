                            ...
                            <div class="col-3">
                                <div class="form-group" id="form-group">
                                    ...
                                    <input type="text" name="nomeCliente" id="nomeCliente" class="form-control"
                                        maxlength="25" value="{{ old('nomeCliente') }}"
                            ...
                            <div class="col-3">
                                ...
                                <div class="form-group" id="form-group">
                                    <label class="modal-label">Confirmar Senha:</label> <label
                                        style="color: red; font-size: 12px;"> * </label>
                                    <input type="password" name="senhaCliente_confirmation"
                                        id="senhaCliente_confirmation" class="form-control"
                            ...
                            <div class="col-03">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ncasaCliente" id="ncasaCliente" class="form-control"
                                        maxlength="4" value="{{ old('ncasaCliente') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="switch__container">
                                        <input id="switch-shadow" name="statusCliente"
                                            value={{ 'Ativo' ?? 'Inativo' }} class="switch switch--shadow"
                                            type="checkbox">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group" id="form-group">
                                    ...
                                    <input type="text" name="nomeClienteUp" id="nomeClienteUp" class="form-control"
                                        maxlength="25" value="{{ old('nomeClienteUp') }}"
                                        placeholder="Entre com o Nome" autofocus>
                                    <div class="div-feedback">
                                ...
                                <div class="form-group" id="form-group">
                                    <label class="modal-label">Email para Login:</label> <label
                                        style="color: red; font-size: 12px;"> * </label>
                                    <input type="text" name="usuarioClienteUp" id="usuarioClienteUp"
                                        class="form-control" value="{{ old('usuarioClienteUp') }}"
                                ...
                                <div class="form-group" id="form-group">
                                    ...
                                    <input type="text" name="cnpjClienteUp" id="cnpjClienteUp"
                                        class="cnpj form-control" value="{{ old('cnpjClienteUp') }}"
                            ...
                            <div class="col-3">
                                ...
                                <div class="form-group" id="form-group">
                                    ...
                                    <input type="password" name="senhaClienteUp" id="senhaClienteUp"
                                        class="form-control" value="{{ old('senhaClienteUp') }}"
                            ...
                            <div class="col-03">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ruaClienteUp" id="ruaClienteUp" class="form-control"
                                        maxlength="80" value="{{ old('ruaClienteUp') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="complementoClienteUp" id="complementoClienteUp"
                                        ...
                                        value="{{ old('complementoClienteUp') }}"
                                        placeholder="Entre com o Complemento">
                                    <div class="div-feedback">
                                ...
                                <div class="form-group">
                                    <label class="modal-label">Status:</label> <label
                                        ...
                                        * </label><br>
                                    <div class="switch__container">
                                        <input id="switch-shadow" name="statusClienteUp"
                                            value={{ 'Ativo' ?? 'Inativo' }} class="switch switch--shadow"
                                            type="checkbox">
                                        <label for="switch-shadow"></label>
                                    </div>
