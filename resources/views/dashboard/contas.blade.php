                                ...
                                <div class="card-header" id="ch-adaptado">
                                    <h2 class="card-title">Itens da Compra
                                        <a class="btn btn-primary btn-block"
                                            ...
                                            data-backdrop="static" onclick="abrirModal('#modalRegisterItemCompra', '#IDCompras', '#IDItemCompra');">
                                            + Add</a> </h2>
                                </div>
                                <div class="card-body" id="cd-adaptado">
                                    <div class="table-responsive">
    ...
    <div class="modal-dialog">
        <form id="formUpdateContas" autocomplete="off" enctype="multipart/form-data" method="PUT"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="cancela btn btn-secondary btn-danger"
                        data-form="formUpdateContas" data-modal="modalUpdateContas">Cancelar</button>
                                  <button  type="reset" class="limpar btn btn-secondary btn-danger"  data-form="formUpdateContas">Limpar</button>
                <button type="submit" class="btn-register btn btn-primary">Cadastrar</button>
                </div>
            </div>
        </form>
                            ...
                            <div class="card" id="card-consulta-tabela">
                                <div class="card-header" id="ch-adaptado">
                                    <h2 class="card-title">Itens da Compra
                                        <a class="btn btn-primary btn-block"
                                            id="btn-form-consulta-imprimir"
                                            data-backdrop="static" onclick="abrirModal('#modalUpdateItemCompra', '#IDCompras', '#IDItemCompra');">
                                            + Add</a> </h2>
                                </div>
                                <div class="card-body" id="cd-adaptado">
                                    <div class="table-responsive">
                        ...
                        <div class="modal-footer" style="width: 100%; padding: 24px 15px 16px 15px;">
                            <button type="button" class="btn btn-secondary btn-danger cancela"
                                data-form="formUpdateCompras" data-modal="modalUpdateCompras">Cancelar</button>
                                          <button  type="reset" class="limpar btn btn-secondary btn-danger"  data-form="formUpdateCompras">Limpar</button>
                <button type="submit" class="btn-register btn btn-primary">Cadastrar</button>
                        </div>
                    </div>
        </form>
    ...
    <form class="form-cadastro" id="formUpdateItemCompra" method="PUT" autocomplete="off"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="cancela btn btn-secondary btn-danger"
                        data-form="formUpdateItemCompra" data-modal="modalUpdateItemCompra">Cancelar</button>
                                  <button  type="reset" class="limpar btn btn-secondary btn-danger"  data-form="formUpdateItemCompra">Limpar</button>
                <button type="submit" class="btn-register btn btn-primary">Cadastrar</button>
                </div>
            </div>
    </form>
